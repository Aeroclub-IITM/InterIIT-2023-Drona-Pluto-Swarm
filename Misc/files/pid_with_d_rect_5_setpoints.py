...
if __name__ == '__main__':  
    ...
    plutoPID = PID(K_z,K_roll,K_pitch,K_yaw,dt=0.1,tau=0.06,alpha = 0.5,cam_orientation= 0.0, tolerance=20, index = 0,beta=0.5)
    
    hover_height = 175
    x_width = 75
    y_width = 50
    #setpoints = np.array([[50,100,hover_height],[50,0,hover_height],[50,-100,hover_height],[0,-100,hover_height],[-50,-100,hover_height],[-50,0,hover_height],[-50,100,hover_height],[0,0,300]])
