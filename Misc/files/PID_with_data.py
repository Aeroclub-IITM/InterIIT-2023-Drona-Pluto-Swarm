...
class PID:
    ...
    def __init__(self,K_z: list, K_roll: list, K_pitch: list, K_yaw: list, dt:float, tau:float, alpha:float,cam_orientation:float,XT:float,YT:float,ZT:float,beta:float) -> None:
        ...
        self.roll_lower    =1470
        self.pitch_lower   =1470
        self.roll_upper    =1530
        self.pitch_upper   =1530
...
if __name__ == '__main__':  
    ...
    plutoPID = PID(K_z,K_roll,K_pitch,K_yaw,dt=0.1,tau=0.06,alpha = 0.5,cam_orientation= 230.0,XT=0,YT=0,ZT=200,beta=0.5)
