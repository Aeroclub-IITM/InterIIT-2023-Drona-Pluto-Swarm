...
class PID:
    ...
    def __init__(self,K_z: list, K_roll: list, K_pitch: list, K_yaw: list, dt:float, tau:float, alpha:float,cam_orientation:float, tolerance:float, index:int) -> None:
...
if __name__ == '__main__':  
    ...
    plutoPID = PID(K_z,K_roll,K_pitch,K_yaw,dt=0.1,tau=0.06,alpha = 0.5,cam_orientation= 180.0, index=0)    

    plutoPID.set_target(0, 0, 199)
    ...
    plutoPID.set_target(-100, -50, 199)
    while not plutoPID.reached_target:
        pass
